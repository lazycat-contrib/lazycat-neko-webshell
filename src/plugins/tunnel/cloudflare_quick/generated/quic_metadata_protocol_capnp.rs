...
pub mod connect_request {
    ...
    impl<'a> Reader<'a> {
        ...
        #[inline]
        pub fn get_type(self) -> ::core::result::Result<crate::plugins::tunnel::cloudflare_quick::generated::quic_metadata_protocol_capnp::ConnectionType,::capnp::NotInSchema>{
            ::core::convert::TryFrom::try_from(self.reader.get_data_field::<u16>(0))
        }
        #[inline]
        pub fn get_metadata(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::plugins::tunnel::cloudflare_quick::generated::quic_metadata_protocol_capnp::metadata::Owned>>{
            ::capnp::traits::FromPointerReader::get_from_pointer(
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn set_type(
            &mut self,
            value: crate::plugins::tunnel::cloudflare_quick::generated::quic_metadata_protocol_capnp::ConnectionType,
        ) {
            self.builder.set_data_field::<u16>(0, value as u16);
        }
        #[inline]
        pub fn get_metadata(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::plugins::tunnel::cloudflare_quick::generated::quic_metadata_protocol_capnp::metadata::Owned>>{
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
        ...
        pub fn set_metadata(
            &mut self,
            value: ::capnp::struct_list::Reader<'_,crate::plugins::tunnel::cloudflare_quick::generated::quic_metadata_protocol_capnp::metadata::Owned>,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
        ...
        #[inline]
        pub fn init_metadata(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::plugins::tunnel::cloudflare_quick::generated::quic_metadata_protocol_capnp::metadata::Owned>{
    ...
    mod _private {
        ...
        pub(crate) fn get_field_types(index: u16) -> ::capnp::introspect::Type {
            match index {
                ...
                1 => <crate::plugins::tunnel::cloudflare_quick::generated::quic_metadata_protocol_capnp::ConnectionType as ::capnp::introspect::Introspect>::introspect(),
                2 => <::capnp::struct_list::Owned<crate::plugins::tunnel::cloudflare_quick::generated::quic_metadata_protocol_capnp::metadata::Owned> as ::capnp::introspect::Introspect>::introspect(),
...
impl ::capnp::introspect::Introspect for ConnectionType {
    fn introspect() -> ::capnp::introspect::Type {
        ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema::new(
            &connection_type::ARENA,
            connection_type::get_annotation_types,
        ))
        .into()
    }
}
...
mod connection_type {
    pub(crate) static ENCODED_NODE: [::capnp::Word; 34] = [
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(152, 0, 0, 0, 209, 0, 0, 0),
        ::capnp::word(21, 0, 0, 0, 98, 1, 0, 0),
        ::capnp::word(41, 0, 0, 0, 7, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub mod connect_response {
    ...
    mod _private {
        ...
        pub(crate) fn get_field_types(index: u16) -> ::capnp::introspect::Type {
            match index {
                0 => <::capnp::text::Owned as ::capnp::introspect::Introspect>::introspect(),
                1 => <::capnp::struct_list::Owned<crate::plugins::tunnel::cloudflare_quick::generated::quic_metadata_protocol_capnp::metadata::Owned> as ::capnp::introspect::Introspect>::introspect(),
                _ => ::capnp::introspect::panic_invalid_field_index(index),
            }
        }
        pub(crate) fn get_annotation_types(
