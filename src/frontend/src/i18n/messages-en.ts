export const enMessages = {
  ...
  "mobileComposer.insert": "Insert",
  "mobileComposer.send": "Send + Enter",
  "mobileComposer.discard": "Discard draft",
  "mobileComposer.empty": "Type or paste some text first.",
  "mobileComposer.tooLarge": "Text must be at most 64 KiB.",
  "mobileComposer.unavailable": "Connect a writable terminal first.",
  "mobileComposer.failed": "Could not insert. Your draft has been kept.",
  "mobileComposer.sending": "Inserting…",
  "mobileComposer.close": "Close",
  "mobilePalette.title": "Phrases and keys",
  "mobilePalette.search": "Search phrases or keys",
  "mobilePalette.clear": "Clear search",
  "mobilePalette.recent": "Recent",
  "mobilePalette.all": "All phrases",
  "mobilePalette.keys": "Keys",
  "mobilePalette.empty": "Add quick phrases in mobile settings to reuse commands and prompts.",
  "mobilePalette.noRecent": "Used phrases will appear here.",
  "mobilePalette.noMatches": "No matching items",
  "mobilePalette.enter": "Sends Enter",
  "mobilePalette.insert": "Insert only",
  "mobilePalette.sending": "Sending…",
  "mobilePalette.failed": "Could not send. Check the terminal connection.",
  "mobilePalette.unavailable": "This target or item has changed. Reopen the panel to try again.",
  "mobilePalette.close": "Close",
  "mobileOverview.panes": "{count} panes",
  "mobileOverview.connected": "Connected",
  "mobileOverview.idle": "Not connected",
  "mobileOverview.connecting": "Connecting",
  "mobileOverview.replaying": "Restoring",
  "mobileOverview.reconnecting": "Reconnecting",
  "mobileOverview.offline": "Offline",
  "mobileOverview.fatal": "Connection failed",
  ...
  "secret.files": "Created files",
  "secret.created": "Secret file created",
  "secret.permissions": "Only the target login user can read and write · 600",
  "secret.insert": "Insert into terminal",
  "secret.copy": "Copy path",
  "secret.copied": "Path copied",
  "secret.copyFailed": "Could not copy. Select the path above and copy it manually.",
  "secret.targetChanged": "The original terminal is unavailable or has changed. You can still copy the path.",
  "secret.cleanupHint": "Delete after use. Closing this panel keeps the file; system cleanup timing varies.",
  "secret.aiHint": "If an AI or agent reads this file, its contents may still enter their context.",
  "secret.delete": "Delete file",
  "secret.another": "Create another",
  "secret.insertFailed": "Could not insert. The path is still available to copy.",
  "secret.inserted": "Path inserted without pressing Enter",
  "secret.deleting": "Deleting…",
  "secret.deleted": "File deleted",
  "secret.deleteFailed": "Could not delete. Check the target connection and try again.",
  "secret.manual": "Paste secret text",
  "secret.manualHint": "Formatting is preserved. Text is cleared after saving or closing.",
  "secret.generate": "Create file",
  "secret.invalidText": "Paste non-empty text, up to 1 MiB.",
  "secret.reading": "Reading clipboard…",
  "secret.permission": "Clipboard access was unavailable. Paste the text here instead.",
  "secret.saving": "Saving secret file…",
  "secret.bodyPrivate": "Only the path will be inserted into the terminal.",
  ...
  "machines.keyboardHint": "Press Shift+Esc in the terminal to return to the controls",
  "machines.source": "Connection source",
  "machines.configSource": "SSH config",
  "machines.manualSource": "Manual entry",
  "machines.noHostOption": "No selectable hosts",
  "machines.manualHint": "Enter user@host, or ssh://user@host:port for a custom port. OpenSSH handles authentication.",
  "machines.title": "Manage machines",
  "machines.scope": "Herdr SSH connections saved by this instance’s login user",
  "machines.add": "Add machine",
  "machines.rename": "Rename",
  "machines.remove": "Remove connection",
  "machines.setup": "Set up machine",
  "machines.search": "Search names or hosts",
  "machines.count": "{count} SSH machines",
  "machines.enabled": "Enabled",
  "machines.disabled": "Disabled",
  "machines.enable": "Enable",
  "machines.disable": "Disable",
  "machines.enableName": "Enable {label}",
  "machines.disableName": "Disable {label}",
  "machines.renameName": "Rename {label}",
  "machines.removeName": "Remove connection to {label}",
  "machines.label": "Display name",
  "machines.sshHost": "Choose from SSH config",
  "machines.target": "SSH target",
  "machines.session": "Remote session",
  "machines.sessionSettings": "Remote session settings",
  "machines.sessionHint": "Uses default unless specified. Letters, numbers, dots, underscores and hyphens are supported.",
  "machines.hostHint": "From the target user’s ~/.ssh/config. OpenSSH keeps your port, key and proxy settings.",
  "machines.noHosts": "No selectable hosts in ~/.ssh/config. Enter user@host, or ssh://user@host:port for a custom port.",
  "machines.hostLoading": "Reading ~/.ssh/config…",
  "machines.hostFailed": "Could not read ~/.ssh/config. Go back to retry, or enter an SSH target.",
  "machines.addHint": "Adding opens a terminal for SSH sign-in and Herdr setup. The connection is saved after setup succeeds.",
  "machines.removeHint": "Removes this connection record from Herdr. Remote sessions keep running; SSH configuration and keys are kept.",
  "machines.loading": "Loading machines…",
  "machines.loadFailed": "Could not load machines",
  "machines.empty": "No saved machines yet",
  "machines.emptyHelp": "Add an SSH machine to keep remote work in your Herdr window.",
  "machines.noMatches": "No matching machines",
  "machines.searchHelp": "Try another name, host or session.",
  "machines.unsupported": "This Herdr version does not support machines",
  "machines.upgrade": "Update Herdr for the target login user, then refresh.",
  "machines.saved": "Connection updated.",
  "machines.changed": "This connection changed. Return to the list and review it before removing.",
  "machines.invalidForm": "Enter a valid SSH target, display name (up to 128 bytes) and remote session name.",
  "machines.startSetup": "Add and set up",
  "machines.setupHint": "Complete sign-in or installation prompts in the terminal. Closing this window cancels setup.",
  "machines.setupFailed": "Setup did not complete. Check the terminal output.",
  "machines.added": "Machine added. Open Herdr clients connect automatically.",
  "machines.keyboard": "Type / open keyboard",
  "machines.cancelSetup": "Cancel and go back",
  "machines.back": "Go back",
  "machines.test": "Test connection",
  "machines.testHint": "Testing SSH. Use the terminal for sign-in or host fingerprint confirmation.",
  "machines.testPassed": "SSH connected successfully. You can now add this machine.",
  "machines.testFailed": "SSH connection failed. Check the terminal output and connection settings.",
  "integrations.title": "Herdr integration status",
  "integrations.hint": "Read-only status for supported agent command integrations on this target.",
  "integrations.loading": "Checking integrations…",
  "integrations.empty": "Herdr reported no integrations.",
  "integrations.refresh": "Refresh status",
  "integrations.summary": "{current} current · {outdated} updates · {total} total",
  "integrations.command": "Command: {command}",
  "integrations.stateCurrent": "Current",
  "integrations.stateOutdated": "Update available",
  "integrations.stateNotInstalled": "Not installed",
  "integrations.stateUnavailable": "Command unavailable",
  "integrations.invalidResponse": "Herdr returned an invalid integration status response.",
  "action.herdrIntegrations": "Integration status",
  "action.closeHerdrSpaceGroup": "Close workspace group…",
  "confirm.closeHerdrSpaceGroupTitle": "Close the entire workspace group?",
  "confirm.closeHerdrSpaceGroup": "Close parent \"{parent}\" and {count} linked worktree workspaces: {children}{extra}. Every pane in this group will be closed.",
  "confirm.closeHerdrSpaceGroupExtra": ", plus {count} more",
  "status.herdrSpaceClosed": "Herdr workspace closed.",
  "status.herdrSpaceGroupClosed": "Herdr workspace group closed.",
  "status.herdrSpaceGroupUnavailable": "This workspace is not the parent of an open worktree group.",
  "status.herdrSpaceGroupChanged": "The worktree group changed before confirmation. Nothing was closed; review it again.",
  "history.title": "Search pane history",
  "history.hint": "Choose a Herdr pane. Searching and copying leave the terminal view unchanged.",
  "history.pane": "Pane",
  "history.query": "Text to find",
  "history.next": "Next match",
  "history.previous": "Previous match",
  "history.refresh": "Refresh search",
  "history.copy": "Copy match",
  "history.match": "Matching text",
  "history.choose": "Choose a pane",
  "history.loading": "Loading panes…",
  "history.ready": "Enter text to search, or move to another match.",
  "history.searching": "Searching…",
  "history.copying": "Copying…",
  "history.copyError": "Copy was blocked. Retry, or select and copy the preview below.",
  "history.copied": "Match copied.",
  "history.empty": "No matches found.",
  "history.unsupported": "This Herdr server does not support history search. Other terminal features remain available.",
  "history.stale": "The pane changed while reading. Refresh the search to use its latest contents.",
  "history.error": "Could not read or copy this match. Refresh the search and try again.",
  "history.targetChanged": "The terminal target changed. Close this window and open history search again.",
  "history.queryTooLong": "Use a shorter search, up to 1,024 characters.",
  "history.position": "Match {current} of {total}",
  ...
  "action.mobileKeyboardUndo": "Undo last layout change",
  "action.mobileKeyboardEditKey": "Edit key",
  "label.mobileKeyboardPreview": "Shortcut preview",
  "setting.mobileKeyboardPreviewHelp": "Preview only; these keys do not send input. Place your most-used keys first to reduce scrolling.",
  "option.mobileKeyboardKeyChord": "Key combination",
  ...
  "option.mobileKeyboardWidthLarge": "Wide",
  "option.mobileKeyboardWidthLargeHint": "roomy",
  "option.mobileKeyboardWidthMedium": "Standard",
  "option.mobileKeyboardWidthMediumHint": "balanced",
  "option.mobileKeyboardWidthSmall": "Narrow",
  "option.mobileKeyboardWidthSmallHint": "compact",
  ...
  "field.quickPhraseSendEnter": "Press Enter after sending this phrase",
  "field.quickPhraseText": "Text",
  "field.mobileKeyboardKeyEnter": "Press Enter after sending this key's text",
  ...
  "field.mobileKeyboardPage": "Shortcut category",
  ...
  "setting.terminalDiagnosticsHelp": "Records connection timing and counters without terminal contents.",
  "action.copyTerminalDiagnostics": "Copy terminal diagnostics",
  "action.downloadTerminalDiagnostics": "Download terminal diagnostics",
  "status.terminalDiagnosticsCopied": "Terminal diagnostics copied",
  "status.terminalDiagnosticsExportFailed": "Could not export diagnostics. Try downloading the file.",
  ...
  "setting.mobileClock24Hour": "Use 24-hour format, for example 18:30",
  "setting.mobileClockEnabled": "Show time beside shortcut tabs",
  "setting.mobileClockEnabledHelp": "Useful when you want the current time visible without opening the system clock.",
  "setting.mobileClockHelp": "Controls the time shown beside the mobile shortcut tabs.",
  "setting.mobileClockPeriod": "Show AM/PM when using 12-hour format",
  "setting.preventMobileKeyboardAutoOpen": "Keep shortcut taps from opening the system keyboard",
  ...
  "setting.preventMobileKeyboardAutoOpenHelpShort": "The keyboard button and a double-tap still open it when you want to type.",
  "setting.quickPhraseSendEnterHelp": "Turn this on for commands that should run immediately after the phrase is sent.",
  "setting.mobileQuickInputHelp": "Save, group, and order personal phrases for the mobile shortcut bar.",
  "setting.mobileKeyboardLayoutHelp": "Choose a preset, switch categories, and arrange the keys as they should appear on the mobile shortcut bar. Editing a preset saves it as Custom.",
  "setting.mobileKeyboardWidthHelp": "Key width legend",
  "setting.mobileKeyboardDragHelp": "Drag the handle to reorder, or use the arrows. Tap the eye to show or hide a key. Changes are saved automatically.",
  "setting.mobileKeyboardKeyEnterHelp": "Useful for commands that should run immediately.",
  ...
  "validation.mobileKeyboardKeyTooLong": "Text must be at most {count} characters after decoding escape sequences. Nothing has been saved.",
